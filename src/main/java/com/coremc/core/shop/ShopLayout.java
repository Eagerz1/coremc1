...
/**
 * Pure layout and pagination maths for the 27-slot (small chest) shop
 * GUIs, so the GUI code can stay dumb and the layout is testable.
 *
 * <pre>
 * Root menu:  [ 4 ] = balance, [10..16] = up to seven sections,
 *             [22] = close, everything else filler.
 * Section:    [0..17] = items (18 per page),
 *             [18] back, [20] previous page, [22] page indicator,
 *             [24] next page, [26] close, everything else filler.
 * </pre>
 */
public final class ShopLayout {

    /** Slots per GUI: a small chest (three rows). */
    public static final int SIZE = 27;

    /** Item slots per section page (rows 0-1). */
    ...
    public static final int SLOT_PREVIOUS = 20;
    public static final int SLOT_PAGE = 22;
