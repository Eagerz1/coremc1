 ...
 * command: list, buy, info, upgrade, luck and luck upgrade, plus the
 * admin tools give, giveitem and setluck.
 */
public final class SpawnerCommand implements CommandExecutor, TabCompleter {

    private static final List<String> PLAYER_SUBS = List.of("list", "buy", "info", "upgrade", "luck");
    private static final List<String> ADMIN_SUBS = List.of("list", "buy", "info", "upgrade", "luck",
